...
# def read_content():
#     """
#     goods_list.txt:存储商品信息的文件
#     per_page_amount:每页展示内容的行数（可根据实际修改）
#     :return:
#     """
#     if not os.path.exists('goods_list.txt'):
#         print('商品列表为空')
#         return
#
#     per_page_amount = 3
...
#             for i in f:
#                 index += 1
#                 if last_pages+1 < index <= last_pages + per_page_amount + 1:
#                     li.append(i.strip())
#                     continue
#             c = 1
#             for i in li:
